                                            ...
                                            <div v-for="product in products" :key="product.id"
                                                ...
                                                <div class="products-three-single w-100  mt-30">
                                                    ...
                                                    <div class="products-three-single-content text-center"> <span>{{ product.category.title }}</span>
                                                        ...
                                                        <p>
                                                            $ {{ product.price }}
                                                            <!-- <del>$ {{ get_old_price(product.price, product.price + 300) }}.00</del> -->
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
...
// methods: {
//         getProducts(){
//             this.axios.get('http://localhost:8876/api/api/products')
//             .then(res =>{
//                 // console.log(res);
...
//         }
//     },
//     // get_old_price(price1, price2){
//     //   return Math.floor(Math.random() * (price2 - price1)) + price1;
//     // },
// }
export default{
    name: "Index",
    ...
    methods: {
        getProducts() {
            this.axios.get('http://localhost:8876/api/api/products')
                ...
                .finally(() => { // Fixed syntax error here
                    $(document).trigger('change');
                });
        },
        getFilterList() {
            this.axios.get('http://localhost:8876/api/api/products/filters').then(res => {
                console.log(res);
            }).finally(() => { // Fixed syntax error here
                $(document).trigger('change');
            });
